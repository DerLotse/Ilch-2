...
INSERT INTO `$prefix_config` (`id`, `group_name`, `config_key`, `category_name`, `config_description`, `field_type`, `config_value`, `field_options`) VALUES
...
INSERT INTO `$prefix_modules` (`id`, `core`, `active`, `name`, `version`) VALUES
(1, 0, 1, 'welcome', '0.0001'),
(2, 1, 1, 'media', '1.0000'),
(3, 0, 1, 'blueprint', '1.0000'),
(4, 0, 1, 'svn', '1.0000');

CREATE TABLE IF NOT EXISTS `$prefix_themes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `active` int(2) NOT NULL,
  `name` varchar(32) NOT NULL,
  `version` decimal(11,4) NOT NULL,
...
INSERT INTO `$prefix_themes` (`id`, `active`, `name`, `version`) VALUES
(1, 1, 'ilchcms', '0.0001');
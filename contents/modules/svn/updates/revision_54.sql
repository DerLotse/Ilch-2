...
ALTER TABLE `ic1_users` ADD `user_status` INT UNSIGNED NOT NULL AFTER `id`;

ALTER TABLE `ic1_config` CHANGE `id` `config_id` INT( 11 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `ic1_sessions` CHANGE `session_id` `session_id` VARCHAR( 24 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL ,
...
ALTER TABLE `ic1_themes` CHANGE `id` `theme_id` INT( 11 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `ic1_users` CHANGE `id` `user_id` INT( 10 ) UNSIGNED NOT NULL AUTO_INCREMENT ,
...
ALTER TABLE `ic1_user_tokens` CHANGE `id` `user_token_id` INT( 11 ) UNSIGNED NOT NULL AUTO_INCREMENT ,

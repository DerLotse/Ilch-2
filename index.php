 ...
 */
define('DIRSEPA', DIRECTORY_SEPARATOR);
...
/**
 * The directory in which your contents are located.
 *
...
define('DOCROOT', realpath(dirname(__FILE__)) . DIRSEPA);
...
if (file_exists(realpath($application).DIRSEPA.'config'.DIRSEPA.'database'.EXT) === FALSE)
{
...
define('MODPATH', realpath($modules) . DIRSEPA);
